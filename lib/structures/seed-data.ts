...
export const CONTENT_STRUCTURES: ContentStructure[] = [
  ...
  },
  {
    ...
    difficulty: 'intermediate',
    blocks: [
      { id: 'problem', label: 'P — Problem', timing: 'Section 1', duration_hint: 'flexible', instruction: 'Identify and describe the specific problem your audience is experiencing. Paint a vivid picture of their pain.', example: '"Ang hirap mag-start ng business kapag walang capital."', rules: ['Be specific to their situation', 'Use their own language', 'Make them feel seen'] },
      { id: 'amplify', label: 'A — Amplify', timing: 'Section 2', duration_hint: 'flexible', instruction: 'Amplify the consequences of NOT solving the problem. Make the pain more urgent.', example: '"Habang nag-iisip ka pa lang, yung kapitbahay mo nagsimula na."', rules: ['Show cost of inaction', 'Create urgency without manipulation', 'Connect to emotional consequences'] },
      { id: 'story', label: 'S — Story / Solution', timing: 'Section 3', duration_hint: 'flexible', instruction: 'Share a relatable story or introduce the solution. Bridge from pain to hope.', example: '"Same situation ko dati. 3 years akong nag-plan lang."', rules: ['Use personal or customer story', 'Make transition natural', 'Keep it authentic'] },
      { id: 'transformation', label: 'T — Transformation', timing: 'Section 4', duration_hint: 'flexible', instruction: 'Show the before-and-after. What does life look like AFTER the solution?', example: '"Now, I earn 30-50K a month from my kitchen table."', rules: ['Show concrete results', 'Make it aspirational but believable', 'Connect to original pain'] },
      { id: 'offer', label: 'O — Offer', timing: 'Section 5', duration_hint: 'flexible', instruction: 'Present your specific offer. What exactly are you selling? Make it clear and compelling.', example: '"My Starter Kit — 5 sheets, 50 designs, cutter, and video guide. Only P499."', rules: ['Be specific about what they get', 'Include price if applicable', 'Frame as investment'] },
      { id: 'response', label: 'R — Response / CTA', timing: 'Section 6', duration_hint: 'flexible', instruction: 'Tell them exactly what to do next. Simple and immediate.', example: '"Comment STARTER and I will send you the link."', rules: ['One clear action', 'Low friction', 'Add urgency without being pushy'] }
    ],
    ideal_length_min: 60,
